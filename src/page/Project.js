  ...
  return (
    <div className='text-white'>
      <div className="h-[400px] relative bg-cover bg-center text-white" style={{ backgroundImage: `url(${Site})` }}>
        ...
        <h1 className='text-3xl text-white mt-[200px] ml-[20px] lg:ml-[100px]'>Projects</h1>
        <p className='w-400px'>Here are some of our construction projects in Nigeria. Some are complete, while others are still under construction. Take a look!</p>
      </div>
      <Projects/>
    </div>
  );
