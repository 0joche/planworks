  ...
  return (
    <div className='text-white'>
      ...
      <div className='mt-10 p-5 text-black'>
        <p className='mb-5'>At PlanWorks Consulting Services Ltd, our team is the driving force behind every successful project we deliver.</p>
        <p className='mb-5'>Comprising seasoned professionals with diverse backgrounds in Oil & Gas, Construction, Real Estate, and Government infrastructure, our experts bring years of combined experience in project planning, scheduling, monitoring, and control.</p>
        <p className='mb-5'>We are planners, engineers, analysts, and strategists united by a shared commitment to precision, innovation, and results.</p>
        <p className='mb-5'>Each member of our team is handpicked not just for technical expertise, but for a proactive mindset and a passion for helping clients meet critical project milestones—on time and within budget.</p>
