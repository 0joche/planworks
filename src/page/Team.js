  ...
  return (
    <div className='text-white'>
      <div className="h-[400px] relative bg-cover bg-center text-white" style={{ backgroundImage: `url(${Site})` }}>
        ...
        <h1 className='text-3xl text-white mt-[200px] ml-[20px] lg:ml-[100px]'>Our Team</h1>
        <p className='w-400px'>The Dutum team is made up of professionals of different fields, for the efficient delivery of our projects.</p>
      </div>
      <Projects/>
    </div>
  );
