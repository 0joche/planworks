  ...
  return (
    <div className="text-black border-t border-black">
      ...
      <h1 className="text-3xl text-black text-center mt-10">
        Staff Accommodation Camp Development – Refinery Project: Planning & Infrastructure Support
      </h1>
      ...
      <h1 className="text-3xl text-black text-center mt-10">
        Refinery Quick-Fix Rehabilitation Project: Planning, Monitoring & Reporting
      </h1>
    </div>
  );
};
